...
contract Candidate is ProxyStorage, AccessibleCommon, CandidateStorage, ILayer2 {
    ...
    function initialize(
        ...
        if (_isLayer2Candidate) {
            require(ILayer2(_candidate).isLayer2(), "Candidate: invalid layer2 contract");
        }
    ...
    function updateSeigniorage() external returns (bool) {
        ...
        require(!isLayer2Candidate, "Candidate: you should update seigniorage from layer2 contract");
