...
contract GEMCore is GEMAuction {
    ...
    function tkGEMwithdrawBalance() external onlyCFO {
        ...
        // Subtract all the currently pregnant tkGEMs we have, plus 1 of margin.
        uint256 subtractFees = (pregnantTkGEM + 1) * autoBirthFee;
