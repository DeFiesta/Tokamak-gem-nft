...
contract SeigManagerMigration is ProxyStorage, AuthControlSeigManager, SeigManagerStorage, SeigManagerI, DSMath {
    ...
    function setCommissionRateOnlyOwner(address layer2, uint256 commissionRate, bool isCommissionRateNegative_)
        external
        onlyOwner
        returns (bool)
    {
        ...
        returns (bool)
    {
        ...
        uint256 totAmount = _additionalTotBurnAmount(layer2, amount);
    ...
    function _additionalTotBurnAmount(address layer2, uint256 amount) internal view returns (uint256 totAmount) {
    ...
    function _increaseTot() internal returns (bool) {
        ...
        ) + (_tot.totalSupply()); // consider additional TOT balance as total supply
    ...
    function _setCommissionRate(address layer2, uint256 commissionRate, bool isCommissionRateNegative_)
        internal
        returns (bool)
    {
